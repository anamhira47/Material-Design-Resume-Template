...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Material resume." />
        <meta name="keywords" content="Material Resume" />
        <meta name="author" content="anamhira47">
    ...
    <body>
        ...
        <header id="header-top"> <!--Start: "Header Area"-->
            <div class="container">
                <div class="row">
                    <div class="top-contact col m12 s12 right">
                        <span><i class="fa fa-envelope"></i> <a target="_Blank" href="mailto:">Your Email</a></span>
                        <span><i class="fa fa-phone"></i> <a href="tel:">Phone Number</a></span> 
                    </div>  
                </div>
            </div>
            ...
            <!-- =========================================
                           NAVIGATION   
    Change the links if you would like
            ==========================================-->
        ...
        <!-- =========================================
                        ABOUT   
Change all the info to suit your needs.
        ==========================================-->
        <section id="about">
            <div class="container">
                <div class="row">
                    <div class="intro z-depth-1 col m12">
                        ...
                        <div class="col m12 s12 co-centered wow fadeIn a2" data-wow-delay="0.2s">
                            <div class="intro-content col m10 s12">
                                <h2>Website Example at</h2>
                                <span><a href="http://www.anamhira.ca/" target="_blank">Anam Hira Website</a></span>
                                <p>Your Bio</p>
                                <a target="_blank" href="/cv.pdf" class="btn waves-effect">Download CV</a>
        ...
        <!-- =========================================
                           SKILLS  
Add your own percentages or change the skills that you would like to display
                            ...
                            <div class="col m6 s12">
                                ...
                                <div class="skill-bar col m10 wow fadeIn a1"  data-wow-delay="0.1s">
                                 <!--  Add your proffesional skills here  -->   <h3>Professional Skills </h3>
                                    ...
                                    <span>HTML</span>
                                    <div class="progress">
                                        <div class="determinate"> 30%</div>
                                    </div>
                                    
                                    <span>CSS</span>
                                    <div class="progress">
                                        <div class="determinate">20%</div>
                                    </div>
        ...
        <!-- ========================================
                WORKS EXPERIENCE  
Add your own work experiances and your own times etc.
        ==========================================-->
        ...
        <!-- =========================================
                EDUCATION  
Add your own work experiances to the HTML file
        ==========================================-->
                ...
                <div class="row">
                    ...
                    <div class="cd-container" id="ed-timeline">
                		...
                		<div class="cd-timeline-block wow fadeIn a4" data-wow-delay="0.4s">
                			...
                			<div class="cd-timeline-content col m5 s12 zf-depth-1">
    ...
    Make sure to go into form.php to set up to phpmailer config 
        ...
        <section id="contact-form">
            <div class="container">
                <div class="row">
                    <div class="section-title wow fadeIn a1" >
                        <h2> <i class="fa fa-send"></i>Contact</h2>
                    </div>
                    <div class="contact-form z-depth-1" id="contact">   
                        <div class="row">                                   
                            <form id="contactForm" data-toggle="validator" method="post" action="form.php">
                                <div id="msgSubmit" class="h3 text-center hidden"></div>
                                <div class="input-field col m6 s12 wow fadeIn a2" data-wow-delay="0.2s">
                                    <label for="name" name="name" class="h4">Full Name *</label>
                                    <input type="text" class="form-control validate" id="name" required data-error="Enter your name pla">
                                </div>
                                <div class="input-field col m6 s12 wow fadeIn a4" data-wow-delay="0.4s">
                                    <label for="email" name="email" class="h4">Email *</label>
                                ...
                                <div class="input-field col m6 s12 wow fadeIn a3" data-wow-delay="0.3s">
                                    <label for="subject" name="subject" class="h4">Subject *</label>
                                    <input type="text" class="form-control validate" id="last_name" required>
                                </div> 
                                 <div class="input-field col m6 s12 wow fadeIn a3" data-wow-delay="0.3s">
                                    <label for="other" name="other" class="h4">Other </label>
                                    <input type="text" class="form-control validate" id="other" >
                                </div> 
                                <div class="input-field col m12 s12 wow fadeIn a6" data-wow-delay="0.6s">
                                    <label for="message" name="message" class="h4 ">Message *</label>
                                    <textarea id="message" class="form-control materialize-textarea validate" required></textarea>           
                                </div>
                                <button type="submit" id="form-submit" class="btn btn-success waves-effect wow fadeIn a7" >Submit</button>
                    ...
                    <!-- =========================================
                            INTEREST  
    Add your own social media links to the code.
                    ==========================================-->
                    
                    <div class="interests col s12 m12 l12 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <ul class="z-depth-1"> <!-- interetsr icon start -->
															<a  href="Your Facebook" target="_Blank"> <li><i class="fa fa-facebook-official tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Facebook"></i></li></a>
															<a href="Your Twitter" target="_Blank">  <li><i class="fa fa-twitter tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Twitter"></i></li></a>
                                <li><i class="fa fa-linkedin tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="linkedin"></i></li>
															<a target="_Blank" href="https://github.com/anamhira47"><li><i class="fa fa-github tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Github"></i></li></a>
															<a href="Your Email" target="_Blank">  <li><i class="fa fa-youtube tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Youtube"></i></li></a>
    ...
    <script src="assets/js/init.js"></script>
        ...
        <!-- =========================================================
            STYLE SWITCHER 
To switch the colour of the template by pressing the gear on the right side.
        ===========================================================-->
