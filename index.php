...
<html lang="en">
    <head>
        ...
        <!-- TITLE OF SITE
        Deploy this material Design HTML template to your website
        -->
        <title> Material Design Resume</title>
        ...
        <!-- STYLE SWITCH STYLESHEET- Optional-->
        <link rel="stylesheet" href="assets/css/demo.css">
    </head>
    <body>
        <!-- =========================================
                           HEADER TOP | Add your contact information
        ==========================================-->
        <header id="header-top"> <!--Start: "Header Area"-->
            <div class="container">
                <div class="row">
                    <div class="top-contact col m12 s12 right">
                        <span><i class="fa fa-envelope"></i> <a href="mailto:hira.anam49@gmail.com">hira.anam49@gmail</a></span>
                        <span><i class="fa fa-phone"></i> <a href="tel:">123 456 6789 </a></span>
                    </div>
                </div>
            </div>

            <!-- =========================================
                          NAVIGATION | You may take out sections if you like
                         but if you do make sure to also take out the corresponding
        ...
        <!-- =========================================
                        ABOUT | Explain yourself to the visitors of the website.
        ==========================================-->
        <section id="about">
            <div class="container">
                <div class="row">
        ...
        <!-- ========================================
                WORKS EXPERIENCE | Add your own work experience
        ==========================================-->
                    ...
                    <div id="cd-timeline" class="cd-container">
                		<div class="cd-timeline-block wow fadeIn a2" data-wow-delay="0.2s">
                			...
                			<div class="cd-timeline-content col m5 s12 z-depth-1">
                				<a href=""><h2>Rapper</h2></a>
                				<span>11 Jan 2015 </span>
                				<p>Rapped, accumulated 11 Grammy nominations.</p>
                		...
                		<div class="cd-timeline-block wow fadeIn a4" data-wow-delay="0.4s">
                			...
                			<div class="cd-timeline-content col m5 s12 z-depth-1">
                				<a href=""><h2>Hockey Player</h2></a>
                				<span>11 Jan 2015 </span>
                				<p>Center for the Vancouver Canucks, led the team in assists.</p>
                			</div> <!-- cd-timeline-content -->
                		</div> <!-- cd-timeline-block -->
                		<div class="cd-timeline-block wow fadeIn a5" data-wow-delay="0.5s">
                			...
                			<div class="cd-timeline-content col m5 s12 z-depth-1">
                				<a href=""><h2>Basketball Player</h2></a>
                				<span>11 Jan 2015 </span>
                				<p>Point Guard for the Toronto Raptors led the team in assists and steals.</p>
                			</div> <!-- cd-timeline-content -->
                		</div> <!-- cd-timeline-block -->
                	</div> <!-- cd-timeline -->
                </div>
        ...
        <!-- =========================================
                    PORTFOLIO | Showcase some of your best work.
        ==========================================-->
        ...
        <section id="portfolio">
            <div class="container">
            	...
            	<!-- =========================================
                        MARKET PLACE | Show the your various items on many markets
                ==========================================-->
        ...
        <!-- =========================================
                EDUCATION | Showcase your education.
        ==========================================-->
                ...
                <div class="row">
                    ...
                    <div class="cd-container" id="ed-timeline">
                        <div class="cd-timeline-block wow fadeIn a2" data-wow-delay="0.2s">
                			...
                			<div class="cd-timeline-content col m5 s12 z-depth-1">
                				<a href=""><h2>Harvard Law</h2></a>
                				<span>11 Jan 2015 </span>
                				<p>Graduated with a law degree at Harvard University with honours.</p>
                			</div> <!-- cd-timeline-content -->
                        </div> <!-- cd-timeline-block -->
                		<div class="cd-timeline-block wow fadeIn a3" data-wow-delay="0.3s">
                			<div class="cd-timeline-img">
                		...
                		<div class="cd-timeline-block wow fadeIn a4" data-wow-delay="0.4s">
                			...
                			<div class="cd-timeline-content col m5 s12 z-depth-1">
                				<a href=""><h2>MIT</h2></a>
                				<span>11 Jan 2015 </span>
                				<p>Aero Space engineering degree at MIT</p>
                			</div> <!-- cd-timeline-content -->
                		</div> <!-- cd-timeline-block -->
                		<div class="cd-timeline-block wow fadeIn a5" data-wow-delay="0.5s">
                			<div class="cd-timeline-img">
        ...
        <!-- =========================================
                BLOG | Add items to your blog, or a link to corresponding items in your real blog
        ==========================================-->
        <section id="blog">
            <div class="container">
                <div class="row">
        ...
        <!-- =========================================
                  PRICING | Sell services right from your website.
         ==========================================-->
        ...
        <section id="clients">
            <div class="container">
                <div class="row">
                    ...
                    <div class="clear"></div>
                    <!-- =========================================
                            CLIENTS LOGO | Showcase the logos of your cliesnts
                    ==========================================-->
        ...
        <!-- =========================================
                CONTACT | Change the contact forms to your liking.
        ==========================================-->
        <section id="contact-form">
            <div class="container">
                <div class="row">
                    ...
                    <!-- =========================================
                            Social Media | Change to your corresponding Social Media Links
                    ==========================================-->
    ...
    <script src="assets/js/init.js"></script>
        ...
        <!-- =========================================================
            STYLE SWITCHER | Change colour of the Website, you could get rid of this feature if you would like.
        ===========================================================-->
